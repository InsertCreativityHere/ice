...
module Test
{
    ...
    [clr:generic:List] sequence<ValStruct> ValStructList;
    [clr:generic:LinkedList] sequence<ValStruct> ValStructLinkedList;
    [clr:generic:Stack] sequence<ValStruct> ValStructStack;
    [clr:generic:Queue] sequence<ValStruct> ValStructQueue;

    dictionary<int, string> IntStringD;
    dictionary<int, ValStruct> IntValStructD;
    dictionary<int, MyInterface*> IntProxyD;
    [clr:generic:SortedDictionary] dictionary<int, string> IntStringSD;
