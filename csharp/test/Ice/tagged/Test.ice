...
module Test
{
    ...
    interface Initial
    {
        ...
        void opTaggedException(tag(1) int? a, tag(2) string? b, tag(3) OneTagged? o) throws TaggedException;

        void opDerivedException(tag(1) int? a, tag(2) string? b, tag(3) OneTagged? o) throws TaggedException;

        void opRequiredException(tag(1) int? a, tag(2) string? b, tag(3) OneTagged? o) throws TaggedException;
        ...
        tag(1) IntOneTaggedDict? opIntOneTaggedDict(tag(2) IntOneTaggedDict? p1, out tag(3) IntOneTaggedDict? p3);
