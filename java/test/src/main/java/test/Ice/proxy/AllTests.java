...
public class AllTests {
  ...
  public static MyClassPrx allTests(test.TestHelper helper) {
    ...
    test(
        proxyProps
            .get("Test.Locator")
            .equals("locator -t -e " + Util.encodingVersionToString(Util.currentEncoding())));
    ...
    test(
        proxyProps
            ...
            .equals("router -t -e " + Util.encodingVersionToString(Util.currentEncoding())));
    ...
    test(
        compObj
            .ice_endpointSelection(EndpointSelectionType.Random)
    ...
    test(
        endpts1[0].equals(
            communicator.stringToProxy("foo:tcp -h 127.0.0.1 -p 10000").ice_getEndpoints()[0]));
    ...
    ObjectPrx p2 =
        communicator.stringToProxy("test:opaque -e 1.1 -t 1 -v CTEyNy4wLjAuMeouAAAQJwAAAA==");
    test(
        communicator.proxyToString(p2).equals("test -t -e 1.1:tcp -h 127.0.0.1 -p 12010 -t 10000"));
