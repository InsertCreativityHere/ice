...
public final class AMDInitialI implements Initial
{
    ...
    @Override
    public CompletionStage<Void> sendOptionalStructAsync(boolean req, Optional<FixedStruct> o, Current current)
    {
        return CompletableFuture.completedFuture(null);
    }

    @Override
    public CompletionStage<Optional<FixedStruct>> returnOptionalStructAsync(boolean req, Current current)
    {
    ...
    @Override
    public CompletionStage<OpMG2MarshaledResult> opMG2Async(G p1, Current current)
    {
