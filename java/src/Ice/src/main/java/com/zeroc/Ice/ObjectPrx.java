...
public interface ObjectPrx {
  ...
  /**
   * Returns the Slice type ID of the most-derived interface supported by the target object of this
   * proxy.
   *
   ...
   */
  com.zeroc.Ice.Object.Ice_invokeResult ice_invoke(
      String operation, OperationMode mode, byte[] inParams, java.util.Map<String, String> context);
   ...
   *
   * @return The facet for this proxy. If the proxy uses the default facet, the return value is the
   *     empty string.
   */
  String ice_getFacet();
   ...
   *
   * @return The adapter ID. If the proxy does not have an adapter ID, the return value is the empty
   *     string.
   */
   ...
   *
   * @param newCache <code>true</code> if the new proxy should cache connections; <code>false</code>
   *     otherwise.
   ...
   *     endpoints. If <code>b</code> is <code>false</code>, the proxy prefers insecure endpoints to
   *     secure ones.
   * @return The proxy with the specified selection policy.
   */
   ...
   *
   * @return The router for the proxy. If no router is configured for the proxy, the return value is
   *     <code>null</code>.
   */
   ...
   *
   * @param co <code>true</code> enables compression for the new proxy; <code>false</code> disables
   *     compression.
  ...
  /**
   * Flushes any pending batched requests for this communicator. The call blocks until the flush is
   * complete.
   */
  ...
  /**
   * Returns whether this proxy equals the passed object. Two proxies are equal if they are equal in
   * all respects, that is, if their object identity, endpoints timeout settings, and so on are all
   * equal.
   *
  ...
  /**
   * Casts a proxy to {@link ObjectPrx}. This call does not contact the server and always succeeds.
   *
   * @param obj The proxy to cast to {@link ObjectPrx}.
   * @return <code>obj</code>.
   */
