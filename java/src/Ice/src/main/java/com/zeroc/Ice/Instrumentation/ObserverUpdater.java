 ...
 * This interface can be used by add-ins implementing the {@link CommunicatorObserver} interface to update the
...
public interface ObserverUpdater
{
     ...
     * {@link CommunicatorObserver#getConnectionObserver} is called. The implementation of getConnectionObserver has
