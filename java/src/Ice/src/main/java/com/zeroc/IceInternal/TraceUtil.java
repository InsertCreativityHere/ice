...
public final class TraceUtil {
  ...
  public static void traceRecv(
      com.zeroc.Ice.InputStream str, com.zeroc.Ice.Logger logger, TraceLevels tl) {
    if (tl.protocol >= 1) {
      int p = str.pos();
      str.pos(0);
  ...
  public static synchronized void traceSlicing(
      String kind, String typeId, String slicingCat, com.zeroc.Ice.Logger logger) {
  ...
  private static void printIdentityFacetOperation(
      java.io.Writer out, com.zeroc.Ice.InputStream stream) {
    try {
  ...
  private static byte printMessage(java.io.StringWriter s, com.zeroc.Ice.InputStream str) {
