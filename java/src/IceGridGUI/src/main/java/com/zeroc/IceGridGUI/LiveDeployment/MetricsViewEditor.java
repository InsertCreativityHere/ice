...
public class MetricsViewEditor extends Editor implements MetricsFieldContext
{
    ...
    public void show(final MetricsView node, final Map<java.lang.String, com.zeroc.Ice.IceMX.Metrics[]> data,
    ...
    static public class DeltaAverageMetricsField extends AbstractField
    {
        ...
        public Object getValue(com.zeroc.Ice.IceMX.Metrics m, long timestamp)
        {
            ...
            // If the elapsed period is less than the refresh period, don't calculate a new value.
                ...
                button.addActionListener(new ActionListener()
                    {
                        ...
                        public void actionPerformed(ActionEvent e)
                        {
                            ...
                            java.util.concurrent.CompletableFuture<com.zeroc.Ice.IceMX.MetricsFailures> r =
        ...
        public Object getValue(final com.zeroc.Ice.IceMX.Metrics m, final long timestamp)
        {
            try
            {
                final com.zeroc.Ice.IceMX.Metrics[] objects =
                    (com.zeroc.Ice.IceMX.Metrics[])m.getClass().getField(getFieldName()).get(m);
