...
// The SessionKeeper is responsible for establishing sessions (one at a time) and keeping them alive.
            ...
            // Buttons
            {
                ...
                AbstractAction importAction = new AbstractAction("Import")
                {
                    ...
                    public void actionPerformed(ActionEvent e)
                    {
                        ...
                        JFileChooser chooser = new JFileChooser(defaultPath.isEmpty() ? null : new File(defaultPath));
