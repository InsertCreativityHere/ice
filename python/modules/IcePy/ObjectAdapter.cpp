...
static PyMethodDef AdapterMethods[] = {
    ...
    {"findDefaultServant",
     ...
     METH_VARARGS,
     PyDoc_STR("findDefaultServant(category: str) -> Ice.Object")},
    {"addServantLocator",
     reinterpret_cast<PyCFunction>(adapterAddServantLocator),
     METH_VARARGS,
     PyDoc_STR("addServantLocator(locator: Ice.ServantLocator, category: str) -> None")},
    {"removeServantLocator",
     reinterpret_cast<PyCFunction>(adapterRemoveServantLocator),
     METH_VARARGS,
     PyDoc_STR("removeServantLocator(category: str) -> Ice.ServantLocator")},
    {"findServantLocator",
     reinterpret_cast<PyCFunction>(adapterFindServantLocator),
     METH_VARARGS,
     PyDoc_STR("findServantLocator(category: str) -> Ice.ServantLocator")},
    {"createProxy",
     reinterpret_cast<PyCFunction>(adapterCreateProxy),
     METH_VARARGS,
     PyDoc_STR("createProxy(identity: Ice.Identity) -> Ice.ObjectPrx")},
    {"createDirectProxy",
     reinterpret_cast<PyCFunction>(adapterCreateDirectProxy),
     METH_VARARGS,
     PyDoc_STR("createDirectProxy(identity: Ice.Identity) -> Ice.ObjectPrx")},
    {"createIndirectProxy",
     reinterpret_cast<PyCFunction>(adapterCreateIndirectProxy),
     METH_VARARGS,
     PyDoc_STR("createIndirectProxy(identity: Ice.Identity) -> Ice.ObjectPrx")},
    {"setLocator",
     reinterpret_cast<PyCFunction>(adapterSetLocator),
     METH_VARARGS,
     PyDoc_STR("setLocator(locator: Ice.LocatorPrx) -> None")},
    {"getLocator",
    ...
    {"setPublishedEndpoints",
     ...
     METH_VARARGS,
     PyDoc_STR("setPublishedEndpoints(newEndpoints: tuple[Endpoint, ...] | list[Endpoint]) -> None")},
    {} /* sentinel */
};
