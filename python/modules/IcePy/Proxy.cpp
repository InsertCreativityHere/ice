...
static PyMethodDef ProxyMethods[] = {
    ...
    {"ice_context",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_context(new_context: dict[str, str]) -> Self")},
    ...
    {"ice_facet",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_facet(facet: str) -> Self")},
    {"ice_getAdapterId",
    ...
    {"ice_endpoints",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_endpoints(newEndpoints: tuple[Endpoint, ...] | list[Endpoint]) -> Self")},
    ...
    {"ice_collocationOptimized",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_collocationOptimized(collocated: bool) -> Self")},
    {"ice_locatorCacheTimeout",
     reinterpret_cast<PyCFunction>(proxyIceLocatorCacheTimeout),
     METH_VARARGS,
     PyDoc_STR("ice_locatorCacheTimeout(timeout: int) -> Self")},
    {"ice_invocationTimeout",
     reinterpret_cast<PyCFunction>(proxyIceInvocationTimeout),
     METH_VARARGS,
     PyDoc_STR("ice_invocationTimeout(timeout: int) -> Self")},
    ...
    {"ice_connectionCached",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_connectionCached(newCache: bool) -> Self")},
    ...
    {"ice_endpointSelection",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_endpointSelection(type: Ice.EndpointSelectionType) -> Self")},
    ...
    {"ice_encodingVersion",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_encodingVersion(version: Ice.EncodingVersion) -> Self")},
    {"ice_getRouter",
    ...
    {"ice_router",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_router(router: Ice.RouterPrx | None) -> Self")},
    {"ice_getLocator",
    ...
    {"ice_locator",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_locator(locator: Ice.LocatorPrx | None) -> Self")},
    {"ice_twoway",
     reinterpret_cast<PyCFunction>(proxyIceTwoway),
     METH_NOARGS,
     PyDoc_STR("ice_twoway() -> Self")},
    ...
    {"ice_batchOneway",
     ...
     METH_NOARGS,
     PyDoc_STR("ice_batchOneway() -> Self")},
    {"ice_isBatchOneway",
    ...
    {"ice_batchDatagram",
     ...
     METH_NOARGS,
     PyDoc_STR("ice_batchDatagram() -> Self")},
    {"ice_isBatchDatagram",
    ...
    {"ice_compress",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_compress(compress: bool) -> Self")},
    {"ice_getCompress",
    ...
    {"ice_connectionId",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_connectionId(connectionId: str) -> Self")},
    {"ice_fixed",
     reinterpret_cast<PyCFunction>(proxyIceFixed),
     METH_VARARGS,
     PyDoc_STR("ice_fixed(connection: Ice.Connection) -> Self")},
