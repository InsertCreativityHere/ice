...
static PyMethodDef ProxyMethods[] = {
    ...
    {"ice_context",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_context(new_context: dict[str, str]) -> Ice.ObjectPrx")},
    ...
    {"ice_router",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_router(router: Ice.RouterPrx | None) -> Ice.ObjectPrx")},
    {"ice_getLocator",
    ...
    {"ice_locator",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_locator(locator: Ice.LocatorPrx | None) -> Ice.ObjectPrx")},
    {"ice_twoway",
    ...
    {"ice_compress",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_compress(compress: bool) -> Ice.ObjectPrx")},
    {"ice_getCompress",
    ...
    {"ice_connectionId",
     ...
     METH_VARARGS,
     PyDoc_STR("ice_connectionId(connectionId: str) -> Ice.ObjectPrx")},
    {"ice_fixed",
     reinterpret_cast<PyCFunction>(proxyIceFixed),
     METH_VARARGS,
     PyDoc_STR("ice_fixed(connection: Ice.Connection) -> Ice.ObjectPrx")},
